...
function App() {
  ...
  const mainContent = useMemo(() => {
    ...
    if (currentPath === "/supplier-signup") return <SupplierSignUpPage onNavigate={navigate} />
    if (currentPath === "/supplier-login") return <SupplierLoginPage onNavigate={navigate} />
    if (currentPath === "/cart")
      return (
        <CartPage
          onNavigate={navigate}
